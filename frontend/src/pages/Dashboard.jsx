...
// Colores ISL
const COLORS = ['#EF4444', '#374151', '#6b7280', '#9ca3af', '#d1d5db'];
...
const BRANCH_COLORS = ['#EF4444', '#22c55e', '#3b82f6', '#ef4444', '#8b5cf6', '#ec4899', '#14b8a6'];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <MetricCard
          title="Resueltas"
          value={totalSales}
          subtitle={`${conversionRate}% resolución`}
          icon={CheckCircle}
          variant="success"
        />
        <MetricCard
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className={`rounded-2xl p-6 border ${isDark ? 'bg-slate-800 border-slate-700' : 'bg-white border-gray-200'}`}>
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className={`text-sm ${isDark ? 'text-slate-400' : 'text-gray-500'}`}>Comparativa por resolución</p>
            </div>
            <Link to="/sellers" className="text-sm text-[#EF4444] font-semibold flex items-center gap-1 hover:text-[#DC2626]">
        ...
        <div className={`rounded-2xl p-6 border ${isDark ? 'bg-slate-800 border-slate-700' : 'bg-white border-gray-200'}`}>
          <div className="mb-6">
            <h3 className={`text-lg font-bold ${isDark ? 'text-white' : 'text-gray-800'}`}>Motivos de no resolución</h3>
            <p className={`text-sm ${isDark ? 'text-slate-400' : 'text-gray-500'}`}>Análisis por motivo principal</p>
          </div>
        ...
        <div className={`rounded-2xl p-6 border ${isDark ? 'bg-slate-800 border-slate-700' : 'bg-white border-gray-200'}`}>
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className={`text-xs ${isDark ? 'text-slate-400' : 'text-gray-500'}`}>Por tasa de resolución</p>
            </div>
          </div>
                ...
                <>
                  ...
                  <div className="flex flex-wrap gap-4 mt-4 pt-4 border-t border-slate-700">
                    ...
                    <div className="flex items-center gap-2 ml-4">
                      ...
                      <span className={`text-xs ${isDark ? 'text-slate-400' : 'text-gray-500'}`}>Resuelto</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-4 h-4 rounded-full bg-gray-400 border-2 border-red-500" />
                      <span className={`text-xs ${isDark ? 'text-slate-400' : 'text-gray-500'}`}>No resuelto</span>
                    </div>
                  </div>
                </>
              ) : (
