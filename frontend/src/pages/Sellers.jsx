    ...
    <div className="space-y-6">
      ...
      {sellers.length === 0 ? (
        <div className={`rounded-2xl p-12 text-center border ${isDark ? 'bg-slate-800 border-slate-700' : 'bg-white border-gray-200'}`}>
          ...
          <h3 className={`text-lg font-semibold mb-2 ${isDark ? 'text-white' : 'text-gray-800'}`}>No hay agentes</h3>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className={`rounded-xl p-4 text-center ${isDark ? 'bg-slate-700/50' : 'bg-gray-50'}`}>
                  ...
                  <p className={`text-xs ${isDark ? 'text-slate-400' : 'text-gray-500'}`}>Resolución</p>
                </div>
              </div>
              ...
              <div className="space-y-3 mb-6">
                <div>
                  <div className="flex items-center justify-between text-sm mb-1">
                    <span className={isDark ? 'text-slate-400' : 'text-gray-500'}>Resueltas</span>
                ...
                <div>
                  <div className="flex items-center justify-between text-sm mb-1">
                    <span className={isDark ? 'text-slate-400' : 'text-gray-500'}>No resuelto</span>
