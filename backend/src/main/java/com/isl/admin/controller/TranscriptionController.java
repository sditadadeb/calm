...
import com.isl.admin.service.S3Service;
...
public class TranscriptionController {
    ...
    public ResponseEntity<List<TranscriptionDTO>> getTranscriptions(
            ...
            @RequestParam(required = false) String resultadoLlamada,
            @RequestParam(required = false) String motivoPrincipal,
        ...
        filter.setResultadoLlamada(resultadoLlamada);
        filter.setMotivoPrincipal(motivoPrincipal);
    ...
    /**
     * Re-analiza solo las transcripciones marcadas como "no resuelto".
    ...
    public ResponseEntity<org.springframework.core.io.InputStreamResource> streamAudio(
        ...
        headers.set("Content-Type", (audioSuffix != null && audioSuffix.contains(".mp4")) ? "video/mp4" : "audio/webm");
