...
import com.isl.admin.model.AdvancedAnalysis;
...
public class AdvancedAnalyzerService {
    ...
    private static final String ADVANCED_ANALYSIS_PROMPT = """
        ...
        1. CONVERSATION_FLOW: Estima el porcentaje de tiempo dedicado a cada fase (deben sumar 100):
           ...
           - descubrimiento: Preguntas sobre la consulta del ciudadano
           - objecion: Momentos donde el ciudadano expresa dudas o desconfianza
           - argumento: Agente explicando información, trámites, opciones
           - cierre: Intento de cerrar la atención, dar solución o derivación
           - silencio: Pausas, silencios, momentos sin interacción clara
        
        2. CUSTOMER_CONFIDENCE: Score 0-100 del nivel de confianza/satisfacción del ciudadano durante la conversación.
           Considera: tono, preguntas del ciudadano, engagement, respuestas positivas.
        
        3. VENDOR_METRICS: Evalúa al agente (cada uno 0-100):
           - vendorTalkPercent: % estimado del tiempo que habla el agente vs ciudadano
           - activeListening: Qué tan bien escucha y responde a la consulta
           - objectionHandling: Cómo maneja las dudas o quejas del ciudadano
           - closingRhythm: Timing y efectividad en dar respuesta o derivar
           - empathy: Nivel de empatía y conexión con el ciudadano
        
        4. OBJECTIONS: Cuenta las objeciones/dudas por tipo:
           - explicit: Dudas claras ("no entendí", "no me sirve")
           - implicit: Dudas indirectas ("después vuelvo", "lo veo")
           - unanswered: Dudas que el agente ignoró
           - ineffective: Dudas respondidas pero sin convencer al ciudadano
        
        5. LOSS_MOMENT (solo si NO hubo resolución):
           - keyPhrase: La frase más relevante del ciudadano antes de que no quedara resuelto
           - abandonMinute: Minuto aproximado donde se perdió la posibilidad de resolución (estimar basado en el flujo)
