...
public class DashboardMetricsDTO {
    ...
    private double averageEscuchaActiva;
    private double protocolComplianceRate;
    private double productOfferingRate;
    private Map<String, Long> visitReasonDistribution;
    ...
    public double getAverageCsat() { return averageCsat; }
    public void setAverageCsat(double averageCsat) { this.averageCsat = averageCsat; }

    public double getAverageEscuchaActiva() { return averageEscuchaActiva; }
    public void setAverageEscuchaActiva(double averageEscuchaActiva) { this.averageEscuchaActiva = averageEscuchaActiva; }

    public double getProtocolComplianceRate() { return protocolComplianceRate; }
    public void setProtocolComplianceRate(double protocolComplianceRate) { this.protocolComplianceRate = protocolComplianceRate; }

    public double getProductOfferingRate() { return productOfferingRate; }
    public void setProductOfferingRate(double productOfferingRate) { this.productOfferingRate = productOfferingRate; }

    public Map<String, Long> getVisitReasonDistribution() { return visitReasonDistribution; }
    public void setVisitReasonDistribution(Map<String, Long> visitReasonDistribution) { this.visitReasonDistribution = visitReasonDistribution; }

    public Map<String, Long> getEmotionalStateDistribution() { return emotionalStateDistribution; }
    public void setEmotionalStateDistribution(Map<String, Long> emotionalStateDistribution) { this.emotionalStateDistribution = emotionalStateDistribution; }

    public long getGrabacionesCortadasCliente() { return grabacionesCortadasCliente; }
    public void setGrabacionesCortadasCliente(long grabacionesCortadasCliente) { this.grabacionesCortadasCliente = grabacionesCortadasCliente; }
