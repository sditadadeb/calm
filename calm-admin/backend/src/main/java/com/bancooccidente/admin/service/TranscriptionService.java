...
import com.bancooccidente.admin.repository.AdvancedAnalysisRepository;
...
public class TranscriptionService {
    ...
    public TranscriptionDTO analyzeTranscription(String recordingId) {
        ...
        transcription.setMotivoVisita(analysis.getMotivoVisita());
        transcription.setEstadoEmocional(analysis.getEstadoEmocional());
        transcription.setCsatScore(analysis.getCsatScore() > 0 ? analysis.getCsatScore() : null);
        ...
        transcription.setGrabacionCortadaCliente(analysis.isGrabacionCortadaCliente());
        transcription.setGrabacionCortadaManual(analysis.isGrabacionCortadaManual());
    ...
    public DashboardMetricsDTO getDashboardMetrics() {
        ...
        Double avgCsat = repository.averageCsatScore();
        metrics.setAverageCsat(avgCsat != null ? avgCsat : 0.0);

        Double avgEscucha = repository.averageEscuchaActiva();
        metrics.setAverageEscuchaActiva(avgEscucha != null ? avgEscucha : 0.0);

        long protocolCompliant = repository.countProtocolCompliant();
        metrics.setProtocolComplianceRate(analyzed > 0 ? calculateRate(protocolCompliant, analyzed) : 0.0);

        long productoOfrecido = repository.countProductoOfrecido();
        metrics.setProductOfferingRate(analyzed > 0 ? calculateRate(productoOfrecido, analyzed) : 0.0);

        metrics.setGrabacionesCortadasCliente(repository.countGrabacionesCortadasCliente());
    ...
    private TranscriptionDTO toDTO(Transcription t) {
        ...
        dto.setMotivoVisita(t.getMotivoVisita());
        dto.setEstadoEmocional(t.getEstadoEmocional());
        dto.setCsatScore(t.getCsatScore());
        ...
        dto.setGrabacionCortadaCliente(t.getGrabacionCortadaCliente());
        dto.setGrabacionCortadaManual(t.getGrabacionCortadaManual());
        return dto;
    }
