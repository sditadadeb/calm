...
public class AnalysisResult {
    ...
    public String getDiarizedTranscript() { return diarizedTranscript; }
    public void setDiarizedTranscript(String diarizedTranscript) { this.diarizedTranscript = diarizedTranscript; }
}
